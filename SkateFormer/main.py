...
def get_parser():
    ...
    parser.add_argument('--config', default='/data/zll/motion_recognition/NC/SkateFormer/config/train/uav_notpart/joint.yaml', help='path to the configuration file')
    ...
    def start(self):
        if self.arg.phase == 'train':
            ...
            for epoch in range(self.arg.start_epoch, self.arg.num_epoch):
                if epoch + 1 < self.arg.num_epoch * 0.6:
